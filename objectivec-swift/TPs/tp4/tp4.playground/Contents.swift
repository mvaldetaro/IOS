...
let personagens:[String?] = ["Mario", nil, "Toad", "Peach", "Bowser", nil]


func opcionais(vetor: [String?]) {
...
if pessoa["altura"] is String {
    print("Altura não é string")
} else {
    print(pessoa["altura"] as! Double)
}

if pessoa["idade"] is Int {

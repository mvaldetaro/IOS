...
//NÂO ESQUECER DE ADD O PROTOCOLO
...
struct ContabilidadeRestaurante {
    ...
    mutating func calcularEImprimirGastos(cozinha:Cozinha) -> String {
        ...
        //print(totalValorDeCusto)
        //print(totalValorDeVenda)
        
        //print("Lucro de " totalValorDeVenda - totalValorDeCusto)
